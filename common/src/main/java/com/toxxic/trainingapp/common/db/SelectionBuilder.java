...
package com.toxxic.trainingapp.common.db;
...
public class SelectionBuilder {
    ...
    public Cursor query(SQLiteDatabase db, String[] columns, String groupBy,
        ...
        Log.v(getClass().getSimpleName(), "query(columns=" + Arrays.toString(columns) + ") " + this);
    ...
    public int update(SQLiteDatabase db, ContentValues values) {
        assertTable();
        Log.v(getClass().getSimpleName(), "update() " + this);
    ...
    public int delete(SQLiteDatabase db) {
        assertTable();
        Log.v(getClass().getSimpleName(), "delete() " + this);
