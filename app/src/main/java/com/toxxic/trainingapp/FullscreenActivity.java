 ...
 */
public class FullscreenActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    public static final String ACTION = "com.toxxic.trainingapp.intent.action.VIDEO_PLAYER_FULL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VideoView v = (VideoView) mContentView;
        String url = null;
