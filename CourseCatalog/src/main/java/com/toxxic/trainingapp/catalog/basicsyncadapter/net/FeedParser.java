...
package com.toxxic.trainingapp.catalog.basicsyncadapter.net;
...
public class FeedParser {
     ...
     * @return List of {@link com.toxxic.trainingapp.catalog.basicsyncadapter.net.FeedParser.Entry} objects.
